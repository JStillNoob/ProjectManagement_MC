            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">
                        ...
                        Edit Regular Employee: {{ $employee->full_name }}
                    </h3>
                </div>
                <div class="card-body">
                    <form action="{{ route('regular-employees.update', $employee) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group">
                            ...
                            <a href="{{ route('regular-employees.show', $employee) }}" class="btn btn-secondary">
