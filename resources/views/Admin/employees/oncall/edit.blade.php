...
@section('title', 'Edit On-Call Employee')
@section('page-title', 'Edit On-Call Employee')
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">
                        ...
                        Edit On-Call Employee: {{ $oncall_employee->full_name }}
                    </h3>
                </div>
                <div class="card-body">
                    <form action="{{ route('oncall-employees.update', $oncall_employee) }}" method="POST"
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('first_name') is-invalid @enderror"
                                        ...
                                        value="{{ old('first_name', $oncall_employee->first_name) }}" required>
                                    @error('first_name')
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('middle_name') is-invalid @enderror"
                                        ...
                                        value="{{ old('middle_name', $oncall_employee->middle_name) }}">
                                    @error('middle_name')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('last_name') is-invalid @enderror"
                                        ...
                                        value="{{ old('last_name', $oncall_employee->last_name) }}" required>
                                    @error('last_name')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control @error('birthday') is-invalid @enderror"
                                        ...
                                        value="{{ old('birthday', $oncall_employee->birthday ? $oncall_employee->birthday->format('Y-m-d') : '') }}"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('house_number') is-invalid @enderror"
                                        ...
                                        value="{{ old('house_number', $oncall_employee->house_number) }}">
                                    @error('house_number')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('street') is-invalid @enderror"
                                        id="street" name="street" value="{{ old('street', $oncall_employee->street) }}">
                                    @error('street')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('barangay') is-invalid @enderror"
                                        ...
                                        value="{{ old('barangay', $oncall_employee->barangay) }}" required>
                                    @error('barangay')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('city') is-invalid @enderror" id="city"
                                        name="city" value="{{ old('city', $oncall_employee->city) }}" required>
                                    @error('city')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('province') is-invalid @enderror"
                                        ...
                                        value="{{ old('province', $oncall_employee->province) }}" required>
                                    @error('province')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('postal_code') is-invalid @enderror"
                                        ...
                                        value="{{ old('postal_code', $oncall_employee->postal_code) }}">
                                    @error('postal_code')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('PositionID') is-invalid @enderror" id="PositionID"
                                        ...
                                        @foreach(\App\Models\Position::active()->get() as $position)
                                            <option value="{{ $position->PositionID }}" {{ old('PositionID', $oncall_employee->PositionID) == $position->PositionID ? 'selected' : '' }}>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control @error('start_date') is-invalid @enderror"
                                        ...
                                        value="{{ old('start_date', $oncall_employee->start_date ? $oncall_employee->start_date->format('Y-m-d') : '') }}"
                                        required>
                                    @error('start_date')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control @error('base_salary') is-invalid @enderror"
                                        ...
                                        value="{{ old('base_salary', $oncall_employee->base_salary) }}" step="0.01" min="0"
                                        readonly>
                                    @error('base_salary')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('contact_number') is-invalid @enderror"
                                        ...
                                        value="{{ old('contact_number', $oncall_employee->contact_number) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            @if($oncall_employee->image_name)
                                <div class="mt-2">
                                    ...
                                    <img src="{{ asset('storage/' . $oncall_employee->image_name) }}" alt="Current photo"
                        ...
                        <div class="form-group">
                            <button type="submit" class="btn btn-warning">
                                <i class="fas fa-save"></i> Update On-Call Employee
                            </button>
                            <a href="{{ route('oncall-employees.show', $oncall_employee) }}" class="btn btn-secondary">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="alert alert-warning">
                        ...
                        <p class="mb-0">On-call employees are typically paid per project or per hour worked, with no fixed
                            monthly salary or benefits.</p>
                    </div>
                </div>
            </div>
        </div>
